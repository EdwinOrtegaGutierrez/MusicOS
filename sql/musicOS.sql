...
-- Volcando datos para la tabla musicos.cliente: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `cliente` DISABLE KEYS */;
INSERT INTO `cliente` (`nombre`, `apellidos`, `correo`, `contrasena`, `codigo_usuario`, `estado`) VALUES
...
-- Volcando datos para la tabla musicos.descuento: ~0 rows (aproximadamente)
...
-- Volcando estructura para procedimiento musicos.insertar_cliente
DELIMITER //
...
DECLARE id INT;
SET existe_cliente = (SELECT COUNT(*) FROM cliente WHERE correo = cor);
IF existe_cliente = 0 THEN
INSERT INTO cliente(nombre, apellidos, correo, contrasena) VALUES (nom, ape, cor, con);
...
-- Volcando datos para la tabla musicos.venta_pedido: ~0 rows (aproximadamente)
